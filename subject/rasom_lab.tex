...
\begin{center}\defaultstyle
\begin{lstlisting}
git clone -b moving_thrusters ttps://github.com/oKermorgant/ecn_rasom.git
\end{lstlisting}
\end{center}
...
At the end of the file we can also find a \texttt{buoyancy} tag that indicates the hydrodynamic propertieso of the robot body. The \texttt{origin} tag is used to set the center of buoyancy, that is usually above the center of gravity.
